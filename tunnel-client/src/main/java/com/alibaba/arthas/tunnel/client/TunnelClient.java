...
public class TunnelClient {
    ...
    private final EventLoopGroup eventLoopGroup = new NioEventLoopGroup(2, new DefaultThreadFactory("arthas-TunnelClient", true));
    ...
    public ChannelFuture connect(boolean reconnect) throws SSLException, URISyntaxException, InterruptedException {
        ...
        if (sellerId != null) {
            queryEncoder.addParam("sellerId", sellerId);
        }
        if (sellerName != null) {
            queryEncoder.addParam("sellerName", sellerName);
        }
        if (storeId != null) {
            queryEncoder.addParam("storeId", storeId);
        }
        if (storeName != null) {
            queryEncoder.addParam("storeName", storeName);
        }
        if (appType != null) {
            queryEncoder.addParam("appType", appType);
        }
        if (appVersion != null) {
            queryEncoder.addParam("appVersion", appVersion);
        }
        if (localIp != null) {
            queryEncoder.addParam("localIp", localIp);
        }
        if (macAddr != null) {
            queryEncoder.addParam("macAddr", macAddr);
        }
